          ...
          <div class="card ">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('articles.edit' ,  $user->id) }}"> <button class="btn btn-primary" type="button">ویرایش</button></a>
                    </td>
                    <td>
                      <button class="btn btn-danger" type="button" data-toggle="modal"
                        data-target="#myModal">حذف</button>
                        <button>
                        <a href="{{ route('articles.destroy', $user->id) }}" onclick="destroyUser(event, {{ $user->id }})" class="item-delete mlg-15" title="حذف"></a>
                      </button>
                    </td>
                  </tr>
                  <form action="{{ route('articles.destroy', $user->id) }}" method="post" id="destroy-user-{{ $user->id }}">
                    @csrf
                    @method('delete')
                  </form>
                  @endforeach
            ...
            <div class="d-flex justify-content-start dataTables_wrapper mt-3">
              <div class="dataTables_paginate paging_simple_numbers " id="basic-1_paginate"><a
                  ...
                  data-dt-idx="7" tabindex="0" id="basic-1_next">بعدی</a>
                </div> 
               </div>
