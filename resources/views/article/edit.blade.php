        ...
        <section>
            ...
            <div class="continer text-aligt text-center" style="text-align: center"><br>
                <div class="form-floating mb-3 " >
                    ...
                    <input type="text" class="form-control" id="floatingInput" placeholder="عنوان مقاله" name="title"  value="{{ $article->title }}"><br>
                  </div>
                    <br>
                  <div class="form-floating">
                    <label for=""> خلاصه مقاله وارد کیند</label>
                    <input type="text" class="form-control" id="floatingPassword" placeholder="خلاصه مقاله" name="content"  value="{{ $article->content }}"> <br>
                  </div><br>
                  <div>
